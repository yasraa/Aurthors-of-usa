...
const Memoir = () => {
  ...
  const paras = [
    <>Premier Memoir Ghostwriting Services </>,
<>To Deliver Your Stories With Confidence</>,
<> A life rich with remarkable experiences and lessons deserves to be shared with the world. Our memoir ghostwriting services are designed to help you bring your story to life. If you have a story worth telling, let’s create it together. Contact our professional memoir ghostwriter today.</>
  ];
  const sectionData = [
    {
      heading: "Your Story, Our Expertise In Memoir Ghostwriting Services",
    ...
    const section2Data = [
    {
      heading: "Create A Lasting Legacy With Professional Memoir Writing Services",
