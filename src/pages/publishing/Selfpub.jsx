...
const Selfpub = () => {
  ...
  const paras = [
    ...
    <>To Empower Your Author Journey With Expert Guidance</>,
    <>That amazing story bubbling inside you, the one you can practically see and hear? It's calling out to be shared. Imagine holding your book in your hands, connecting with readers who will be touched by your words. Our self publishing services are all about helping you make that happen, taking your unique vision and changing it into a real book you can be proud of.</>
    
  
  ]
  const sectionData = [
    {
      heading: "Reliable Self Book Publishing Services Tailored To Your Story ",
      subheading: "We know your book is more than just words, it's a piece of you, a dream you want to share. When you work with our self publishing consultant in USA, you're not just another project, you're a fellow storyteller. ",
      items: [
