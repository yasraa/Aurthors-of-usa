...
const Illustration = () => {
  ...
  const paras = [
    <>Exceptional Book Illustration Services At Best Prices</>,
<>We are your go-to option if you are searching for a book illustrator's service to improve your book</>,
<>At WritersOfUSA, budget-friendly, high-quality book illustration services that elevate your stories. We’re here to help make sure your book stands out, both in words and in art. </>
  ];
  const sectionData = [
    {
      heading: "Partner With Us For Masterful Book Illustrations",
      subheading: "Engaging an illustrator is crucial for the success of your book. An adept illustrator can improve your story with images that fit perfectly with your words. Great illustrations can make your work more mesmerizing be it a children's book, graphic novel, or illustrated fiction.",
      items: [
  "Ghostwriting",
  "Proofreading",
  "Book Editing",
  ...
  "Book Cover Designs"
    ...
    const section2Data = [
    {
      heading: "The Custom Book Illustration Services For Every Author",
      subheading:"Our exceptional book design illustration services can help you create stunning visuals out of your ideas. Your book will connect with readers in no time using the right illustrations. Exceptional illustrations can vividly capture the essence of your narrative, and we are here to make that a reality. ",
      items: [
  ...
  "Fast turnaround times, so your project stays on track."
     ...
     const mainoneData = [
    {
      heading: "The Power Of Professional Book Illustrators For Hire In Captivating Readers",
      subheading:"We offer a full range of services to help bring your book together. We’ve got you covered with everything related to illustrations, ghostwriting, editing, and even book publishing services. Do you need a strong storyline? Or are you looking to refine your manuscript? Our experienced book design illustration team is ready to assist."
    },

  ];
const mainthreeparas = [
<>Make Your Book Unforgettable With Captivating Illustrations</>,
<>A great book needs equally great illustrations. The right artwork can bring your story to a whole new level, making it more interactive for readers of all ages. Our children’s book illustrator for hire, for instance, can give you remarkable assistance and results working on a book for young readers.</>
]
  ...
  },
  {
    ...
    "answer": "Book illustrator’s focus on creating images but some may also assist with formatting and layout, but this is usually handled by a separate designer or a combined service. It’s important to confirm the scope of work before hiring."
  },
  {
