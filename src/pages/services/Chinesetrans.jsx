...
const Chinesetrans = () => {
 ...
 "Ghostwriting",
  ...
  "Book Editing",
    ...
    const section2Data = [
    {
      heading: "Answering The Call Of Global Demand With Chinese Language Translation",
