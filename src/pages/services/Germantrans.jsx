...
const Germantrans = () => {
 ...
 "Ghostwriting",
  ...
  "Book Editing",
    ...
    const section2Data = [
    {
      heading: "Answering The Call Of Global Demand With German Language Translation",
...
const tabs = [
  ...
  },
  {
    ...
    paragraph: "Our literary book German translation offers the thorough approach required to preserve your work's distinct style and feel, especially for works that call for a delicate touch with tone, phrasing, and nuance.",
    img: img1, // main image shown below
