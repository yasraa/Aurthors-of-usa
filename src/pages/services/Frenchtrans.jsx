...
const Frenchtrans = () => {
 ...
 "Ghostwriting",
  ...
  "Book Editing",
    ...
    const section2Data = [
    {
      heading: "Answering The Call Of Global Demand With French Language Translation",
