...
const Booktrans = () => {
  ...
  const paras = [
    ...
    <>Reach Millions In 200+ Languages</>,
    <>Do you want to communicate to readers in their native languages and have your words reach them all over the world? We provide full book translation services as your go-to book translation partner, ensuring that your ideas and stories are understood by a wide range of people. Working with WritersOfUSA gives you the chance to reach new readers and leave a lasting impression as an author.</>
  ]
  const sectionData = [
    {
      heading: "Let Your Words Reach Worldwide With Our Professional Book Translation Services ",
 ...
 "Ghostwriting",
  ...
  "Book Formatting",
    ...
    const section2Data = [
    {
      heading: "Your Go-To Book Translation Company For Global Success",
