...
const Arabictrans = () => {
  ...
  const paras = [
    ...
    <>Weaving Magic through English </>,
    <>Looking to bridge linguistic boundaries and share fascinating stories with a global audience? Our exceptional English-to-Arabic translation book services are here to transform your words into an attractive tale that resonates with Arabic-speaking readers. At WritersofUSA, we're not just translating words; we're forging an immersive experience where every emotion, every twist, and every turn excel in language. We get on a journey with passion and expertise, where stories deserve nothing less than the magic of our linguistic transformation.</>
  ]
  const sectionData = [
    {
      heading: "Beyond Borders. Across Languages. Our Exceptional Arabic Book Translators for Hire ",
 ...
 "Ghostwriting",
  ...
  "Book Formatting",
    ...
    const section2Data = [
    {
      heading: "Answering The Call Of Global Demand With Arabic Language Translation",
